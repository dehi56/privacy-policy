...
- 実行環境: **M4 MacBook Air 24GB**（キャラ設計・画像生成・編集） + **Win機 / RTX 3070 Ti 8GB・RAM 16GB**（動画量産・後処理）。クラウドGPUはLoRA学習時のみ
- ⚠️ 着手前に [メモリ16GBでの必須対策](docs/01-hardware.md#メモリ16gbでの必須対策) を実施すること
